...
._crit_edge_ifconv:
  ...
  %tmp_81_i = call i3 @_ssdm_op_PartSelect.i3.i95.i32.i32(i95 %p_Val2_10, i32 68, i32 70) nounwind
  %p_Val2_23 = select i1 %closepath, i3 0, i3 %tmp_81_i
  ...
  %tmp_82_i = zext i5 %Mx_zeros_V to i49
  %p_Val2_15 = shl i49 %p_Val2_13, %tmp_82_i
  ...
  %tmp_84_i = zext i1 %tmp_12 to i31
  %p_Val2_24 = add i31 %p_Val2_16, %tmp_84_i
  %tmp_85_i = zext i5 %Mx_zeros_V to i8
  %Ex_V = sub i8 %storemerge_i, %tmp_85_i
  %sh_i_cast = sext i8 %Ex_V to i9
  %isNeg = call i1 @_ssdm_op_BitSelect.i1.i8.i32(i8 %Ex_V, i32 7)
  %tmp_87_i = sub i9 0, %sh_i_cast
  %sh_assign = select i1 %isNeg, i9 %tmp_87_i, i9 %sh_i_cast
  %sh_assign_1_i_cast1 = sext i9 %sh_assign to i32
  %sh_assign_1_i_cast = sext i9 %sh_assign to i31
  %tmp_88_i = zext i31 %p_Val2_24 to i32
  %tmp_89_i = lshr i31 %p_Val2_24, %sh_assign_1_i_cast
  %tmp_89_i_cast = zext i31 %tmp_89_i to i32
  %tmp_91_i = shl i32 %tmp_88_i, %sh_assign_1_i_cast1
  %p_Val2_0_i234_in_i = select i1 %isNeg, i32 %tmp_89_i_cast, i32 %tmp_91_i
  %p_Result_s_46 = call i7 @_ssdm_op_PartSelect.i7.i32.i32.i32(i32 %p_Val2_0_i234_in_i, i32 24, i32 30)
  ...
  %p_Result_15 = call i8 @_ssdm_op_BitConcatenate.i8.i1.i7(i1 %sin_basis, i7 %p_Result_s_46)
  ...
  %tmp_74_cast = sext i16 %tmp_4 to i32
  %r_V = add i32 %p_Val2_9, %tmp_74_cast
...
.preheader3:                                      ; preds = %0, %_ifconv
  ...
  %empty_47 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 2, i64 1)
  %i_1 = add i2 %i2, 1
...
; <label>:0                                       ; preds = %.preheader74
  ...
  %tmp_24 = add i14 %phi_mul2, %tmp_6_cast
  %tmp_39_cast = zext i14 %tmp_24 to i64
  %M_addr = getelementptr [12544 x float]* %M, i64 0, i64 %tmp_39_cast
...
.preheader73:                                     ; preds = %.preheader72, %.loopexit
  ...
  %empty_49 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 256, i64 256, i64 256)
  %i_2 = add i9 %i1, 1
...
; <label>:1                                       ; preds = %.preheader72
  ...
  %tmp_30 = call i14 @_ssdm_op_BitConcatenate.i14.i6.i8(i6 %j2, i8 0)
  %tmp_41_cast = zext i14 %tmp_30 to i15
  %tmp_31 = add i15 %tmp_5_cast, %tmp_41_cast
  %tmp_42_cast = zext i15 %tmp_31 to i64
  %xn_input_M_real_addr = getelementptr [12544 x float]* @xn_input_M_real, i64 0, i64 %tmp_42_cast
  %tmp_38 = add i14 %tmp_14_cast, %phi_mul4
  %tmp_43_cast = zext i14 %tmp_38 to i64
  %M_addr_1 = getelementptr [12544 x float]* %M, i64 0, i64 %tmp_43_cast
  %M_load_1 = load float* %M_addr_1, align 4
  store float %M_load_1, float* %xn_input_M_real_addr, align 8
  br label %.preheader72
...
arrayctor.loop3:                                  ; preds = %arrayctor.loop, %arrayctor.loop3
  ...
  %empty_52 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 256, i64 256, i64 256)
...
_ZN3hls6ip_fft8config_tI7config1E6setSchEjj.exit: ; preds = %.preheader
  ...
  %tmp_39 = call i14 @_ssdm_op_BitConcatenate.i14.i6.i8(i6 %i4, i8 0)
  %tmp_45_cast = zext i14 %tmp_39 to i15
  br label %2
...
; <label>:3                                       ; preds = %2
  ...
  %tmp_40 = add i15 %tmp_45_cast, %tmp_18_cast
  %tmp_46_cast = zext i15 %tmp_40 to i64
  %xn_input_M_real_addr_1 = getelementptr [12544 x float]* @xn_input_M_real, i64 0, i64 %tmp_46_cast
...
; <label>:5                                       ; preds = %6, %4
  ...
  %empty_55 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 256, i64 256, i64 256)
  %j_4 = add i9 %j6, 1
  br i1 %exitcond8, label %7, label %6

; <label>:6                                       ; preds = %5
  %tmp_21 = zext i9 %j6 to i64
  %xk_addr_1 = getelementptr [256 x i64]* %xk, i64 0, i64 %tmp_21
  %xk_load = load volatile i64* %xk_addr_1, align 8
  br label %5

; <label>:7                                       ; preds = %5
  %empty_56 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str2, i32 %tmp)
  br label %.preheader

.preheader71:                                     ; preds = %.preheader67, %.preheader
  %frame = phi i6 [ 0, %.preheader ], [ %frame_1, %.preheader67 ]
  %exitcond5 = icmp eq i6 %frame, -15
  %empty_57 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 49, i64 49, i64 49)
...
.preheader70.preheader:                           ; preds = %.preheader71
  %tmp_17_cast1 = zext i6 %frame to i13
  %tmp_17_cast = zext i6 %frame to i10
  br label %.preheader70

.preheader70:                                     ; preds = %8, %.preheader70.preheader
  %i7 = phi i8 [ %i_3, %8 ], [ 0, %.preheader70.preheader ]
  %phi_mul6 = phi i13 [ %next_mul7, %8 ], [ 0, %.preheader70.preheader ]
  %exitcond7 = icmp eq i8 %i7, -127
  %empty_58 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 129, i64 129, i64 129)
  %i_3 = add i8 %i7, 1
  br i1 %exitcond7, label %.preheader69, label %8

; <label>:8                                       ; preds = %.preheader70
  %tmp_19 = zext i8 %i7 to i64
  %next_mul7 = add i13 %phi_mul6, 49
  %tmp_41 = add i13 %tmp_17_cast1, %phi_mul6
  %tmp_48_cast = zext i13 %tmp_41 to i64
  %M_addr_2 = getelementptr [12544 x float]* %M, i64 0, i64 %tmp_48_cast
  %M_load = load float* %M_addr_2, align 4
  %tmp_20 = fmul float %M_load, %M_load
  %z2_addr = getelementptr inbounds [129 x float]* %z2, i64 0, i64 %tmp_19
  store float %tmp_20, float* %z2_addr, align 4
  br label %.preheader70

.preheader69:                                     ; preds = %.preheader70, %10
  %j8 = phi i5 [ %j_5, %10 ], [ 0, %.preheader70 ]
  %phi_mul8 = phi i10 [ %next_mul9, %10 ], [ 0, %.preheader70 ]
  %next_mul9 = add i10 %phi_mul8, 49
  %j8_cast7 = zext i5 %j8 to i8
  %exitcond9 = icmp eq i5 %j8, -12
  %empty_59 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 20, i64 20, i64 20)
  %j_5 = add i5 %j8, 1
...
; <label>:9                                       ; preds = %.preheader68
  ...
  %tmp_25 = add i12 %tmp1_cast, %p_shl
  %tmp_26 = zext i12 %tmp_25 to i64
  %melfb_addr = getelementptr inbounds [2580 x float]* @melfb, i64 0, i64 %tmp_26
  %melfb_load = load float* %melfb_addr, align 4
  %tmp_27 = zext i8 %x to i64
  %z2_addr_1 = getelementptr inbounds [129 x float]* %z2, i64 0, i64 %tmp_27
  %z2_load = load float* %z2_addr_1, align 4
  %tmp_28 = fmul float %melfb_load, %z2_load
  %sum = fadd float %p_x_assign, %tmp_28
  br label %.preheader68

; <label>:10                                      ; preds = %.preheader68
  %tmp_i = call float @llvm.log.f32(float %p_x_assign) nounwind
  %tmp_42 = add i10 %tmp_17_cast, %phi_mul8
  %tmp_50_cast = zext i10 %tmp_42 to i64
  %z_addr = getelementptr [980 x float]* %z, i64 0, i64 %tmp_50_cast
...
._crit_edge78:                                    ; preds = %.preheader67
  %tmp_22 = icmp eq i5 %k, 0
  %p_s = select i1 %tmp_22, float 0x3FCC9F25C0000000, float 0x3FD43D1360000000
  %tmp_23 = sitofp i32 %k_cast3 to float
  br label %11

; <label>:11                                      ; preds = %12, %._crit_edge78
  %sum9 = phi float [ 0.000000e+00, %._crit_edge78 ], [ %sum_1, %12 ]
  %n1 = phi i5 [ 0, %._crit_edge78 ], [ %n, %12 ]
  %phi_mul3 = phi i10 [ 0, %._crit_edge78 ], [ %next_mul2, %12 ]
  %n1_cast2 = zext i5 %n1 to i32
  %exitcond12 = icmp eq i5 %n1, -12
  %empty_62 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 20, i64 20, i64 20)
  %n = add i5 %n1, 1
  br i1 %exitcond12, label %13, label %12

; <label>:12                                      ; preds = %11
  %next_mul2 = add i10 %phi_mul3, 49
  %tmp_44 = add i10 %tmp_17_cast, %phi_mul3
  %tmp_54_cast = zext i10 %tmp_44 to i64
  %z_addr_1 = getelementptr [980 x float]* %z, i64 0, i64 %tmp_54_cast
  %z_load = load float* %z_addr_1, align 4
  %tmp_32 = sitofp i32 %n1_cast2 to float
  %tmp_33 = fmul float %tmp_32, 2.000000e+00
  %tmp_34 = fadd float %tmp_33, 1.000000e+00
  %tmp_35 = fmul float %tmp_34, 0x400921FB00000000
  %tmp_36 = fmul float %tmp_35, %tmp_23
  %p_x_assign_2 = fdiv float %tmp_36, 4.000000e+01
  %tmp_i_i_i_i = call fastcc float @dut_sinf_or_cosf(float %p_x_assign_2) nounwind
  %tmp_37 = fmul float %z_load, %tmp_i_i_i_i
  %sum_1 = fadd float %sum9, %tmp_37
  br label %11

; <label>:13                                      ; preds = %11
  %tmp_29 = fmul float %p_s, %sum9
  %tmp_43 = add i10 %tmp_17_cast, %phi_mul1
  %tmp_52_cast = zext i10 %tmp_43 to i64
  %X_addr = getelementptr [980 x float]* %X, i64 0, i64 %tmp_52_cast
  store float %tmp_29, float* %X_addr, align 4
...
.preheader17.preheader:                           ; preds = %1
  ...
  %tmp_61_cast = zext i14 %tmp_s to i64
  %training_data2_addr = getelementptr [13734 x float]* %training_data2, i64 0, i64 %tmp_61_cast
...
.preheader16:                                     ; preds = %.preheader17, %2
  ...
  %empty_64 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 49, i64 49, i64 49)
  %k_2 = add i6 %k, 1
...
; <label>:2                                       ; preds = %.preheader16
  ...
  %tmp_44 = add i14 %phi_mul5, %tmp1_cast
  %tmp_45 = zext i14 %tmp_44 to i64
  %training_data_V_addr = getelementptr [14000 x i6]* @training_data_V, i64 0, i64 %tmp_45
  %training_data_V_load = load i6* %training_data_V_addr, align 1
  %tmp_51 = zext i6 %training_data_V_load to i32
  %tmp_46 = uitofp i32 %tmp_51 to float
  %next_mul = add i10 %i_cast_cast, %phi_mul
  %tmp_50_cast = zext i10 %phi_mul to i14
  %tmp_52 = add i14 %phi_mul7, %tmp_50_cast
  %tmp_66_cast = zext i14 %tmp_52 to i64
  %training_data2_addr_1 = getelementptr [13734 x float]* %training_data2, i64 0, i64 %tmp_66_cast
  store float %tmp_46, float* %training_data2_addr_1, align 4
  br label %.preheader16

; <label>:3                                       ; preds = %.preheader17
  %tmp = call i2 @_ssdm_op_PartSelect.i2.i9.i32.i32(i9 %phi_mul3, i32 7, i32 8)
  %tmp_39 = zext i2 %tmp to i32
  %tmp_40 = sitofp i32 %tmp_39 to float
  store float %tmp_40, float* %training_data2_addr, align 4
  br label %1

.preheader15:                                     ; preds = %.preheader14, %1
  %i1 = phi i5 [ 0, %1 ], [ %i_5, %.preheader14 ]
  %phi_mul4 = phi i14 [ 0, %1 ], [ %next_mul3, %.preheader14 ]
  %next_mul3 = add i14 %phi_mul4, 686
...
.preheader14:                                     ; preds = %.preheader13, %.preheader15
  ...
  %phi_mul10 = phi i14 [ 0, %.preheader15 ], [ %next_mul9, %.preheader13 ]
  %next_mul9 = add i14 %phi_mul10, 981
  %j2_cast = zext i4 %j2 to i10
  %exitcond6 = icmp eq i4 %j2, -2
  %empty_66 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 14, i64 14, i64 14)
  %j_7 = add i4 %j2, 1
...
.preheader13:                                     ; preds = %.preheader14, %4
  ...
  %phi_mul11 = phi i10 [ %next_mul12, %4 ], [ 0, %.preheader14 ]
  %exitcond5 = icmp eq i6 %k3, -15
  %empty_67 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 49, i64 49, i64 49)
  %k_3 = add i6 %k3, 1
  br i1 %exitcond5, label %.preheader14, label %4

; <label>:4                                       ; preds = %.preheader13
  %next_mul10 = add i10 %i1_cast_cast, %phi_mul9
  %tmp_52_cast = zext i10 %phi_mul9 to i14
  %tmp_47 = add i14 %phi_mul10, %tmp_52_cast
  %tmp_69_cast = zext i14 %tmp_47 to i64
  %training_data2_addr_2 = getelementptr [13734 x float]* %training_data2, i64 0, i64 %tmp_69_cast
  %training_data2_load = load float* %training_data2_addr_2, align 4
  %next_mul12 = add i10 %j2_cast, %phi_mul11
  %tmp_54_cast = zext i10 %phi_mul11 to i14
  %tmp_50 = add i14 %phi_mul4, %tmp_54_cast
  %tmp_70_cast = zext i14 %tmp_50 to i64
  %training_instance_addr = getelementptr [13720 x float]* %training_instance, i64 0, i64 %tmp_70_cast
...
.preheader12:                                     ; preds = %.preheader15, %8
  ...
  %phi_mul6 = phi i10 [ %next_mul7, %8 ], [ 0, %.preheader15 ]
  %phi_mul8 = phi i14 [ %next_mul5, %8 ], [ 0, %.preheader15 ]
  %next_mul5 = add i14 %phi_mul8, 686
...
.preheader11.preheader:                           ; preds = %.preheader12
  %tmp_42 = zext i5 %i4 to i64
  %min_distance_addr = getelementptr inbounds [20 x i32]* %min_distance, i64 0, i64 %tmp_42
  %group_addr = getelementptr inbounds [20 x i32]* %group, i64 0, i64 %tmp_42
  br label %.preheader11

.preheader11:                                     ; preds = %._crit_edge18, %.preheader11.preheader
  %j5 = phi i4 [ %j_8, %._crit_edge18 ], [ 0, %.preheader11.preheader ]
  %phi_mul12 = phi i14 [ %next_mul11, %._crit_edge18 ], [ 0, %.preheader11.preheader ]
  %next_mul11 = add i14 %phi_mul12, 981
  %j5_cast6 = zext i4 %j5 to i10
  %exitcond3 = icmp eq i4 %j5, -2
  %empty_69 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 14, i64 14, i64 14)
  %j_8 = add i4 %j5, 1
  br i1 %exitcond3, label %8, label %.preheader.preheader

.preheader.preheader:                             ; preds = %.preheader11
  %tmp_49 = zext i4 %j5 to i64
  %tmp_53 = add i14 %phi_mul12, 980
  %tmp_68_cast = zext i14 %tmp_53 to i64
  %training_data2_addr_3 = getelementptr [13734 x float]* %training_data2, i64 0, i64 %tmp_68_cast
  %distance_addr = getelementptr inbounds [14 x i32]* %distance, i64 0, i64 %tmp_49
  br label %.preheader

.preheader:                                       ; preds = %._crit_edge, %.preheader.preheader
  %k6 = phi i6 [ %k_4, %._crit_edge ], [ 0, %.preheader.preheader ]
  %phi_mul13 = phi i10 [ %next_mul13, %._crit_edge ], [ 0, %.preheader.preheader ]
  %exitcond = icmp eq i6 %k6, -15
  %empty_70 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 49, i64 49, i64 49)
  %k_4 = add i6 %k6, 1
  br i1 %exitcond, label %7, label %5

; <label>:5                                       ; preds = %.preheader
  %tmp_56_cast = zext i6 %k6 to i10
  %tmp_55 = add i10 %tmp_56_cast, %phi_mul6
  %tmp_71_cast = zext i10 %tmp_55 to i64
  %input_addr = getelementptr [980 x float]* %input_r, i64 0, i64 %tmp_71_cast
  %input_load = load float* %input_addr, align 4
  %next_mul13 = add i10 %phi_mul13, %j5_cast6
  %tmp_58_cast = zext i10 %phi_mul13 to i14
  %tmp_56 = add i14 %tmp_58_cast, %phi_mul8
  %tmp_72_cast = zext i14 %tmp_56 to i64
  %training_instance_addr_1 = getelementptr [13720 x float]* %training_instance, i64 0, i64 %tmp_72_cast
  ...
  %tmp_32 = trunc i32 %p_Val2_s to i31
  %tmp_33 = trunc i32 %p_Val2_s to i23
  %p_Result_s = call i32 @_ssdm_op_BitConcatenate.i32.i1.i31(i1 false, i31 %tmp_32)
...
; <label>:6                                       ; preds = %5
  ...
  %tmp_59 = add nsw i32 %distance_load_1, 1
  store i32 %tmp_59, i32* %distance_addr, align 4
  br label %._crit_edge
...
; <label>:7                                       ; preds = %.preheader
  ...
  %tmp_54 = icmp slt i32 %distance_load, %min_distance_load
  br i1 %tmp_54, label %_ifconv, label %._crit_edge18
...
_ifconv:                                          ; preds = %7
  ...
  %tmp_115_i_i = sub i8 127, %loc_V
  %tmp_115_i_i_cast = sext i8 %tmp_115_i_i to i9
  %sh_assign_1 = select i1 %isNeg, i9 %tmp_115_i_i_cast, i9 %sh_assign
  %sh_assign_1_cast = sext i9 %sh_assign_1 to i32
  %sh_assign_1_cast_cast = sext i9 %sh_assign_1 to i24
  %tmp_116_i_i = zext i32 %sh_assign_1_cast to i78
  %tmp_117_i_i = lshr i24 %p_Result_21, %sh_assign_1_cast_cast
  %tmp_119_i_i = shl i78 %tmp_i_i, %tmp_116_i_i
  %tmp_37 = call i1 @_ssdm_op_BitSelect.i1.i24.i32(i24 %tmp_117_i_i, i32 23)
  %tmp_57 = zext i1 %tmp_37 to i32
  %tmp_58 = call i32 @_ssdm_op_PartSelect.i32.i78.i32.i32(i78 %tmp_119_i_i, i32 23, i32 54)
  %p_Val2_28 = select i1 %isNeg, i32 %tmp_57, i32 %tmp_58
...
; <label>:8                                       ; preds = %.preheader11
  ...
  %tmp_48 = icmp eq i32 %group_load, 0
  %group_zero = add nsw i32 %group_zero_s, 1
  %group_one = add nsw i32 %group_one_s, 1
  %group_zero_1 = select i1 %tmp_48, i32 %group_zero, i32 %group_zero_s
  %group_one_1 = select i1 %tmp_48, i32 %group_one_s, i32 %group_one
...
; <label>:0                                       ; preds = %.preheader
  %tmp_60 = zext i32 %i_i to i64
  %xn_addr = getelementptr [256 x i64]* %xn, i64 0, i64 %tmp_60
  %xn_load = load i64* %xn_addr, align 8
  %xk_addr = getelementptr [256 x i64]* %xk, i64 0, i64 %tmp_60
...
; <label>:1                                       ; preds = %2, %0
  %tmp_V_1 = phi i32 [ undef, %0 ], [ %tmp_V_2, %2 ]
  %i = phi i14 [ 0, %0 ], [ %i_8, %2 ]
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_V_3 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %strm_in_V_V)
  %p_Result_s = call i64 @_ssdm_op_BitConcatenate.i64.i32.i32(i32 %tmp_V_3, i32 %tmp_V_2)
  %tmp_s = uitofp i64 %p_Result_s to float
  %tmp_61 = fdiv float %tmp_s, 1.000000e+05
  %tmp_62 = fadd float %tmp_61, -1.000000e+00
  %tmp_63 = zext i14 %i to i64
  %sound_in_addr = getelementptr inbounds [12544 x float]* %sound_in, i64 0, i64 %tmp_63
  store float %tmp_62, float* %sound_in_addr, align 4
  br label %1
...
; <label>:3                                       ; preds = %1
  ...
  call void @_ssdm_op_Write.ap_fifo.volatile.i32P(i32* %strm_out_V_V, i32 %tmp_V_1)
  ret void
}
...
; <label>:0                                       ; preds = %_ZrsILi41ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit, %arrayctor.loop1.preheader
  ...
  %empty_71 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 4, i64 4, i64 4)
...
._crit_edge143:                                   ; preds = %.preheader
  %tmp_39 = trunc i3 %i_2 to i2
  %Li = call i6 @_ssdm_op_BitConcatenate.i6.i2.i1.i3(i2 %tmp_39, i1 false, i3 %i_2)
  %Li_cast1 = zext i6 %Li to i7
  %Li_cast = zext i6 %Li to i32
  %Ui = add i7 16, %Li_cast1
  %Ui_1_cast = zext i7 %Ui to i32
  %tmp_68 = zext i3 %i_2 to i64
  %pps_V_addr_4 = getelementptr [5 x i41]* %pps_V, i64 0, i64 %tmp_68
  %p_Val2_31 = load i41* %pps_V_addr_4, align 8
  %tmp_40 = trunc i41 %p_Val2_31 to i17
  %loc_V = zext i17 %tmp_40 to i95
  %tmp_41 = icmp ugt i32 %Li_cast, %Ui_1_cast
  %tmp_42 = zext i6 %Li to i7
  %tmp_43 = sub i7 -34, %tmp_42
  %tmp_44 = select i1 %tmp_41, i7 %tmp_42, i7 %Ui
  %tmp_45 = select i1 %tmp_41, i7 %Ui, i7 %tmp_42
  %tmp_46 = select i1 %tmp_41, i7 %tmp_43, i7 %tmp_42
  %tmp_47 = sub i7 -34, %tmp_44
  %tmp_48 = zext i7 %tmp_46 to i95
  %tmp_49 = zext i7 %tmp_45 to i95
  %tmp_50 = zext i7 %tmp_47 to i95
  %tmp_51 = shl i95 %loc_V, %tmp_48
  %tmp_52 = call i95 @llvm.part.select.i95(i95 %tmp_51, i32 94, i32 0)
  %tmp_53 = select i1 %tmp_41, i95 %tmp_52, i95 %tmp_51
  %tmp_54 = shl i95 -1, %tmp_49
  %tmp_55 = lshr i95 -1, %tmp_50
  %p_demorgan = and i95 %tmp_54, %tmp_55
  %tmp_56 = xor i95 %p_demorgan, -1
  %tmp_57 = and i95 %p_Val2_s, %tmp_56
  %tmp_58 = and i95 %tmp_53, %p_demorgan
  %p_Result_22 = or i95 %tmp_57, %tmp_58
  br label %.preheader

; <label>:1                                       ; preds = %.preheader
  %pps_V_addr_3 = getelementptr [5 x i41]* %pps_V, i64 0, i64 4
  %pps_V_load_1 = load i41* %pps_V_addr_3, align 16
  %tmp_38 = trunc i41 %pps_V_load_1 to i27
  %p_Result_s = call i95 @llvm.part.set.i95.i27(i95 %p_Val2_s, i27 %tmp_38, i32 68, i32 94)
  ret i95 %p_Result_s
}
...
entry:
  ...
  %empty_73 = trunc i32 %empty to i9
  ret i9 %empty_73
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_74 = trunc i32 %empty to i8
  ret i8 %empty_74
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_75 = trunc i32 %empty to i7
  ret i7 %empty_75
}
...
entry:
  ...
  %empty_76 = trunc i16 %empty to i7
  ret i7 %empty_76
}
...
entry:
  ...
  %empty_77 = trunc i95 %empty to i49
  ret i49 %empty_77
}
...
entry:
  ...
  %empty_78 = trunc i78 %empty to i32
  ret i32 %empty_78
}
...
entry:
  ...
  %empty_79 = trunc i62 %empty to i31
  ret i31 %empty_79
}
...
entry:
  ...
  %empty_80 = trunc i49 %empty to i31
  ret i31 %empty_80
}
...
entry:
  %empty = call i95 @llvm.part.select.i95(i95 %0, i32 %1, i32 %2)
  %empty_81 = trunc i95 %empty to i3
  ret i3 %empty_81
}
...
entry:
  ...
  %empty_82 = trunc i41 %empty to i24
  ret i24 %empty_82
}
...
entry:
  ...
  %empty_83 = trunc i40 %empty to i24
  ret i24 %empty_83
}
...
entry:
  ...
  %empty_84 = trunc i31 %empty to i23
  ret i23 %empty_84
}
...
entry:
  %empty = call i49 @llvm.part.select.i49(i49 %0, i32 %1, i32 %2)
  %empty_87 = trunc i49 %empty to i18
  ret i18 %empty_87
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_88 = trunc i32 %empty to i17
  ret i17 %empty_88
}
...
entry:
  ...
  %empty_89 = trunc i18 %empty to i17
  ret i17 %empty_89
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_90 = trunc i32 %empty to i16
  ret i16 %empty_90
}
...
entry:
  %empty = call i31 @llvm.part.select.i31(i31 %0, i32 %1, i32 %2)
  %empty_91 = trunc i31 %empty to i16
  ret i16 %empty_91
}
...
entry:
  %empty = call i16 @llvm.part.select.i16(i16 %0, i32 %1, i32 %2)
  %empty_92 = trunc i16 %empty to i1
  ret i1 %empty_92
}
...
entry:
  ...
  %empty_93 = shl i9 1, %empty
  %empty_94 = and i9 %0, %empty_93
  %empty_95 = icmp ne i9 %empty_94, 0
  ret i1 %empty_95
}
...
entry:
  ...
  %empty_96 = shl i8 1, %empty
  %empty_97 = and i8 %0, %empty_96
  %empty_98 = icmp ne i8 %empty_97, 0
  ret i1 %empty_98
}
...
entry:
  ...
  %empty_99 = shl i49 1, %empty
  %empty_100 = and i49 %0, %empty_99
  %empty_101 = icmp ne i49 %empty_100, 0
  ret i1 %empty_101
}
...
entry:
  %empty = shl i32 1, %1
  %empty_102 = and i32 %0, %empty
  %empty_103 = icmp ne i32 %empty_102, 0
  ret i1 %empty_103
}
...
entry:
  ...
  %empty_104 = shl i24 1, %empty
  %empty_105 = and i24 %0, %empty_104
  %empty_106 = icmp ne i24 %empty_105, 0
  ret i1 %empty_106
}
...
entry:
  ...
  %empty_107 = shl i2 1, %empty
  %empty_108 = and i2 %0, %empty_107
  %empty_109 = icmp ne i2 %empty_108, 0
  ret i1 %empty_109
}
...
entry:
  ...
  %empty_110 = zext i1 %1 to i8
  %empty_111 = shl i8 %empty, 1
...
entry:
  ...
  %empty_113 = zext i7 %1 to i8
  %empty_114 = shl i8 %empty, 7
...
entry:
  ...
  %empty_116 = zext i32 %1 to i64
  %empty_117 = shl i64 %empty, 32
...
entry:
  ...
  %empty_119 = zext i3 %2 to i4
  %empty_120 = shl i4 %empty, 3
  %empty_121 = or i4 %empty_120, %empty_119
  %empty_122 = zext i2 %0 to i6
  %empty_123 = zext i4 %empty_121 to i6
  %empty_124 = shl i6 %empty_122, 4
  %empty_125 = or i6 %empty_124, %empty_123
  ret i6 %empty_125
}
...
entry:
  ...
  %empty_126 = zext i3 %1 to i4
  %empty_127 = shl i4 %empty, 3
  %empty_128 = or i4 %empty_127, %empty_126
  ret i4 %empty_128
}
...
entry:
  ...
  %empty_129 = zext i19 %1 to i32
  %empty_130 = shl i32 %empty, 19
...
entry:
  ...
  %empty_132 = zext i23 %2 to i31
  %empty_133 = shl i31 %empty, 23
  %empty_134 = or i31 %empty_133, %empty_132
  %empty_135 = zext i1 %0 to i32
  %empty_136 = zext i31 %empty_134 to i32
  %empty_137 = shl i32 %empty_135, 31
  %empty_138 = or i32 %empty_137, %empty_136
  ret i32 %empty_138
}
...
entry:
  ...
  %empty_139 = zext i31 %1 to i32
  %empty_140 = shl i32 %empty, 31
...
entry:
  ...
  %empty_142 = zext i1 %1 to i31
  %empty_143 = shl i31 %empty, 1
  %empty_144 = or i31 %empty_143, %empty_142
  ret i31 %empty_144
}
...
entry:
  ...
  %empty_145 = zext i23 %1 to i24
  %empty_146 = shl i24 %empty, 23
...
entry:
  ...
  %empty_148 = zext i1 %1 to i19
  %empty_149 = shl i19 %empty, 1
  %empty_150 = or i19 %empty_149, %empty_148
  ret i19 %empty_150
}
...
entry:
  ...
  %empty_157 = zext i8 %1 to i14
  %empty_158 = shl i14 %empty, 8
  %empty_159 = or i14 %empty_158, %empty_157
  ret i14 %empty_159
}
...
entry:
  ...
  %empty_160 = zext i7 %1 to i12
  %empty_161 = shl i12 %empty, 7
  %empty_162 = or i12 %empty_161, %empty_160
  ret i12 %empty_162
}
...
!opencl.kernels = !{!0, !7, !13, !17, !23, !23, !29, !29, !17, !17, !33, !36, !17, !17, !38, !41, !41, !36, !47, !49, !52, !54, !54, !17, !57, !17, !17, !17, !17, !17, !60, !60, !17, !17, !62, !17, !65, !17, !67, !69, !69, !17, !38, !70, !70, !17, !17, !17, !17, !17, !17, !72, !72, !72, !72, !17, !17, !74, !74, !17, !17, !76, !76, !76, !76, !17, !17, !17, !17, !79, !79}
!hls.encrypted.func = !{}
!llvm.map.gv = !{!82}
...
!60 = metadata !{null, metadata !30, metadata !9, metadata !61, metadata !15, metadata !56, metadata !6}
!61 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<64> &"}
!62 = metadata !{null, metadata !30, metadata !9, metadata !63, metadata !15, metadata !64, metadata !6}
!63 = metadata !{metadata !"kernel_arg_type", metadata !"const struct ap_uint<32> &"}
!64 = metadata !{metadata !"kernel_arg_name", metadata !"din"}
!65 = metadata !{null, metadata !30, metadata !9, metadata !66, metadata !15, metadata !35, metadata !6}
!66 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<32> &"}
!67 = metadata !{null, metadata !30, metadata !9, metadata !68, metadata !15, metadata !32, metadata !6}
!68 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<32, false> &"}
!69 = metadata !{null, metadata !30, metadata !9, metadata !68, metadata !15, metadata !56, metadata !6}
!70 = metadata !{null, metadata !42, metadata !43, metadata !71, metadata !45, metadata !46, metadata !6}
!71 = metadata !{metadata !"kernel_arg_type", metadata !"ap_int_base<64, false>*", metadata !"int", metadata !"int"}
...
!74 = metadata !{null, metadata !30, metadata !9, metadata !75, metadata !15, metadata !32, metadata !6}
!75 = metadata !{metadata !"kernel_arg_type", metadata !"double"}
!76 = metadata !{null, metadata !30, metadata !9, metadata !77, metadata !15, metadata !78, metadata !6}
