...
begin
    ...
    xn_read         <= ap_ce and xn_empty_n and xn_tready;
    xk_write        <= ap_ce and xk_full_n and xk_tvalid;
    ...
    process (ap_clk) begin
        if ap_clk'event and ap_clk = '1' then
            if ap_rst = '1' then
                ...
                if xk_full_n = '1' and xk_tvalid = '1' and xk_tlast = '1' then
                    ap_done <= '1';
                else
                    ap_done <= '0';
                end if;
