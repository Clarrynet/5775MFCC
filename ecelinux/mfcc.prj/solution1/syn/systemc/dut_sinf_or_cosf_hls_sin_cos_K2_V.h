...
#ifndef __dut_sinf_or_cosf_hls_sin_cos_K2_V_H__
#define __dut_sinf_or_cosf_hls_sin_cos_K2_V_H__
...
struct dut_sinf_or_cosf_hls_sin_cos_K2_V_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dut_sinf_or_cosf_hls_sin_cos_K2_V_ram) {
...
SC_MODULE(dut_sinf_or_cosf_hls_sin_cos_K2_V) {
...
dut_sinf_or_cosf_hls_sin_cos_K2_V_ram* meminst;


SC_CTOR(dut_sinf_or_cosf_hls_sin_cos_K2_V) {
meminst = new dut_sinf_or_cosf_hls_sin_cos_K2_V_ram("dut_sinf_or_cosf_hls_sin_cos_K2_V_ram");
