...
#ifndef __dut_uitofp_64ns_32_6__HH__
#define __dut_uitofp_64ns_32_6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_uitofp_64ns_32_6) {
    ...
    SC_CTOR(dut_uitofp_64ns_32_6):  ACMP_uitofp_U ("ACMP_uitofp_U") {
